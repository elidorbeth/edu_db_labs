...
|***ПЕРЕДУМОВИ:***|Опитування створене, налаштовані параметри доступу та визначені потенційні респонденти|
|***РЕЗУЛЬТАТ:***|Опитування розіслано користувачам, доступ до нього відкритий|
|***ВИКЛЮЧНІ СИТУАЦІЇ:***|Некоректно вказані адресати, технічні проблеми з розсилкою або доступом до опитування|
|***ОСНОВНИЙ СЦЕНАРІЙ:***|1.Адміністратор вибирає опитування для поширення.<br>2.Визначає методи розсилки (email, посилання, соціальні мережі тощо).<br>3.Система генерує унікальні посилання або коди доступу.<br>4.Опитування надсилається респондентам.<br>5.Адміністратор отримує підтвердження про успішну розсилку.<br>6.Користувачі отримують запрошення та можуть перейти до заповнення опитування.<br>|
...
|***ПЕРЕДУМОВИ:***|Користувач отримав доступ до опитування та може його заповнити|
|***РЕЗУЛЬТАТ:***|Відповіді успішно збережено в системі|
|***ВИКЛЮЧНІ СИТУАЦІЇ:***|Переривання сеансу через технічні збої або незаповнені обов’язкові поля|
|***ОСНОВНИЙ СЦЕНАРІЙ:***|1.Користувач відкриває доступне опитування.<br>2.Заповнює всі необхідні поля, вводячи або вибираючи відповіді.<br>3.Натискає кнопку підтвердження для відправлення даних.<br>4.Система перевіряє коректність введених даних.<br>5.У разі успішного проходження валідації відповіді зберігаються, а користувач отримує підтвердження.<br>|

### Оцінка ефективності
|***ID:***|BUC.001.006| 
|---|---|
|***НАЗВА:***|Оцінка ефективності|
|***УЧАСНИКИ:***|Адміністратор, аналітик, система|
|***ПЕРЕДУМОВИ:***|Опитування завершене, достатня кількість відповідей отримана|
|***РЕЗУЛЬТАТ:***|Згенерований аналітичний звіт із оцінкою ефективності|
|***ВИКЛЮЧНІ СИТУАЦІЇ:***|Недостатньо відповідей для аналізу, помилки при обробці даних|
|***ОСНОВНИЙ СЦЕНАРІЙ:***|1.Система збирає всі надані відповіді.<br>2.Виконується аналіз отриманих даних.<br>3.Формується статистичний звіт із ключовими показниками.<br>4.Адміністратор або аналітик переглядає результати через інтерфейс.<br>5.За потреби звіт експортується у файл або розсилається відповідним учасникам.<br>|
